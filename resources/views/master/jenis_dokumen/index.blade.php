...
@section('title')
    ...
    <button id="btn-crt" onclick="create()" class="ml-1 mb-2 btn btn-success btn-sm rounded-circle"><i class="fa fa-plus-circle"></i></button>
@endsection
        ...
        dataTable =  $('#table').DataTable({
            ...
            columns:[
                ...
                {data: 'id', name:'objek.id', width: '100px', searchable: false, orderable: false, class: 'text-right nowrap',mRender: function(data){
                    return '<button id="btn-edt"class="btn btn-warning btn-sm" onclick="edit('+data+'); enableBtn()">edit</button>\n\
