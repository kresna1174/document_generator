...
class objek_m extends Model
{
    ...
    public function scope_Koneksi($query){
        return $query->select('koneksi.nama_db', 'koneksi.judul', 'koneksi.username', 'koneksi.password', 'koneksi.host', 'koneksi.port', 'objek.objek','objek.id', 'objek.nama_table', 'objek.id_koneksi', 'objek.id_objek_tipe', 'objek.nama_kolom', 'objek.query', 'objek_tipe.objek_tipe', 'jenis_dokumen.nama_surat', 'jenis_dokumen.file')
